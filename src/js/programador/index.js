...
const guardar = async (evento) => {
    ...
    const url = '/final_IS2_alvarado/API/programador/guardar';
    const config = {
        method : 'POST',
        // body: otroNombre
        body
...
const buscar = async () => {
    ...
    const url = `/final_IS2_alvarado/API/programador/buscar?programador_grado=${programador_grado}&programador_nombre=${programador_nombre}&programador_apellido=${programador_apellido}`;
    const config = {
        method : 'GET'
    }
...
const modificar = async () => {
    ...
    const body = new FormData(formulario)
    const url = '/final_IS2_alvarado/API/programador/modificar';
    const config = {
        method : 'POST',
        body
    }
...
const eliminar = async (id) => {
    if(await confirmacion('warning','¿Desea eliminar este registro?')){
        ...
        const url = '/final_IS2_alvarado/API/programador/eliminar';
        const config = {
            method : 'POST',
            body
        }
